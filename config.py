...
class Oneforall:
    ...
    # 免费的API限速1秒查询1次
    shodan_api_key = ''
    # https://x.threatbook.cn/nodev4/vb4/myAPI
    threatbook_api_key = ''
    ...
    proxy_pool = [{'http': 'http://127.0.0.1:7890',
                   'https': 'https://127.0.0.1:7890'}]  # 代理池
    # 网络请求设置
